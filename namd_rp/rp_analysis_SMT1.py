...
exe=rootdir+'/NAMD_3.1alpha1_Linux-x86_64-multicore/namd3'
#
...
# For pair interaction analysis with NAMD (MultiCore build)
# We will assign 7 cores and zero GPUs to NAMD
...
def main():
    ...
    try:
        ...
        for task_i in taskDirs: 
            ...
            # For pair interaction calculation, no GPU allowed
            
            td.executable  = exe + " +p5 +setcpuaffinity "+cwd+task_i+'/'+"pair.namd > pair.log" 
